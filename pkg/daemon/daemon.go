...
type Daemon struct {
	...
	initialNodeAnnotationsFilePath string
...
func New(
	...
	return &Daemon{
		...
		initialNodeAnnotationsFilePath: constants.InitialNodeAnnotationsFilePath,
...
func (dn *Daemon) getStateAndConfigs() (*stateAndConfigs, error) {
	_, err := os.Lstat(dn.initialNodeAnnotationsFilePath)
