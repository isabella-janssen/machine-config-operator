...
func (ctrl *Controller) syncGeneratedMachineConfig(pool *mcfgv1.MachineConfigPool, configs []*mcfgv1.MachineConfig) error {
	...
	if apierrors.IsNotFound(err) {
		...
		ctrl.eventRecorder.Eventf(pool, corev1.EventTypeNormal, "RenderedConfigGenerated", "%s successfully generated (release version: %s, controller version: %s)",
			generated.Name, generated.Annotations[commonconsts.ReleaseImageVersionAnnotationKey], generated.Annotations[commonconsts.GeneratedByControllerVersionAnnotationKey])
	}
	if err != nil {
		return err
	}
...
func generateRenderedMachineConfig(pool *mcfgv1.MachineConfigPool, configs []*mcfgv1.MachineConfig, cconfig *mcfgv1.ControllerConfig) (*mcfgv1.MachineConfig, error) {
	...
	for _, config := range configs {
		generatedByControllerVersion := config.Annotations[commonconsts.GeneratedByControllerVersionAnnotationKey]
	...
	merged.Annotations[commonconsts.GeneratedByControllerVersionAnnotationKey] = version.Hash
	merged.Annotations[commonconsts.ReleaseImageVersionAnnotationKey] = cconfig.Annotations[commonconsts.ReleaseImageVersionAnnotationKey]
